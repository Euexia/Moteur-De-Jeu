//#include "UDP/Client/UDPClientStart.h"
//
...
//						if (!client.sendto(reinterpret_cast<const unsigned char*>(phrase.c_str()), static_cast<unsigned int>(phrase.length())))
//						{
